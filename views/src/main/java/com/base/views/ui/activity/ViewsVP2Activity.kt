...
import com.base.common.constant.CommonMethod
import com.base.library.mvvm.VMActivity
import com.base.views.R
import com.base.views.databinding.ViewsActivityVp2Binding
import com.base.views.transformer.ScaleInTransformer
import com.base.views.ui.fragment.ViewsVP2Fragment

// ViewPage2 Fragment 基本使用
class ViewsVP2Activity : VMActivity<ViewsActivityVp2Binding>() {

    private val vP2Adapter by lazy { VP2Adapter(CommonMethod.getStrs(5)) }
...
class VP2Adapter(private val mStrs: MutableList<String>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PageViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.views_fragment_vp2, parent, false)
...
class AdapterFragmentPage(fragmentActivity: FragmentActivity) :
    ...
    init {
        fragments.put(0, ViewsVP2Fragment.newInstance(0))
        fragments.put(1, ViewsVP2Fragment.newInstance(1))
        fragments.put(2, ViewsVP2Fragment.newInstance(2))
    }
