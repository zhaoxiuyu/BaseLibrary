 ...
 * User: 方法来自 https://github.com/liujingxing/rxhttp/wiki/Cookie%E7%AE%A1%E7%90%86
 */
public class CookieManager implements ICookieJar {
    ...
    // 磁盘缓存 + 内存
    public CookieManager(@Nullable File directory) {
        this(directory, Integer.MAX_VALUE, true);
    }

    // 磁盘缓存 + 内存缓存自己设置
    public CookieManager(@Nullable File directory, boolean enabledMemory) {
     ...
     */
    public CookieManager(@Nullable File directory, long maxSize, boolean enabledMemory) {
