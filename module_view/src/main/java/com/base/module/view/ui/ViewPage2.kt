...
import com.base.module.view.adapter.AdapterFragmentPage
import com.base.module.view.adapter.VP2Adapter
import com.base.module.view.databinding.ActivityViewpage2Binding
import com.base.module.view.transformer.ScaleInTransformer
...
class ViewPage2 : BActivity() {
    ...
    private val vP2Adapter by lazy { VP2Adapter(ViewsMethod.getStrs(5)) }
...
//        vp2.adapter = vP2Adapter // 和 RecyclerView 的适配器一样使用
        mBind.vp2.adapter = AdapterFragmentPage(this) // 使用 Fragment
